	...
	<div class="full-fs-caption">
		<div class="caption-container">
			<div class="archive-title">
				<h1><?php printf( __( 'Résultats pour : %s', 'oneline-lite' ), get_search_query() ); ?><img src="https://skergoat.com/wordpress/wp-content/uploads/2019/11/lookfor.png" alt="smiley detective"/></h1>
			</div>
		</div>
	</div>
</div>
