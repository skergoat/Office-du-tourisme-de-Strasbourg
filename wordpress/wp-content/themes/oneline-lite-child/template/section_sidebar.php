...
<?php
if(!oneline_lite_checkbox_filter('sidebar','section_on_off')) :
...
<section id="ribbon" class="mon-ribbon" data-center="<?php echo $prlx_data_center;?>" data-top-bottom="<?php echo $prlx_top_bottom;?>" style="background: url('<?php echo get_theme_mod('ribbon_bg_image'); ?>')" >
            <div class="container">
                <div class="ribon-box">
                    ...
                    <!-- widget area supplementaire -->
                    <!--  <?php if ( is_active_sidebar( 'new-widget-area' ) ) : ?>
                       <div id="header-widget-area" class="nwa-header-widget widget-area mon-widget" role="complementary">
