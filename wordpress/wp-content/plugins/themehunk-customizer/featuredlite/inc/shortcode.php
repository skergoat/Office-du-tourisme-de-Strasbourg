...
<div class="container">
    <div class="main-text wow fadeInDown" data-wow-duration="2s">
...
<?php elseif($section=='three-column'): ?>
  <li class="featured-section first wow fadeInLeftBig" data-wow-duration="2s">
  ...
  <li class="featured-section second wow fadeInUpBig" data-wow-duration="2s">
  ...
  <li class="featured-section third wow fadeInRightBig" data-wow-duration="2s">
...
<?php if(get_theme_mod( 'about_us_image')!=''){?>
    <div class="aboutus-image wow fadeInRight" data-wow-duration="1s">
    ...
    <?php } ?>
    <div class="aboutus-text wow fadeInLeft" data-wow-duration="1s">
...
<?php if(get_theme_mod( 'hb_heading_bottom')==''){?>
                    <h2 class="heading-area wow fadeInLeft" data-wow-duration="2s"><?php _e('Lorem Ipsum is simply dummy text of the printing and typesetting industry.','featuredlite'); ?></h2>

      <?php } else { ?>
                 <h2 class="heading-area wow fadeInLeft" data-wow-duration="2s"><?php echo get_theme_mod( 'hb_heading_bottom'); ?></h2>
          <?php } ?>

          <?php if(get_theme_mod( 'hb_button_text_bottom','Read More')!=''){?>
                          <div class="ribbon-button wow fadeInRight" data-wow-duration="2s">
...
<?php elseif($section=='ribbon'):
 if(get_theme_mod( 'hb_heading')==''){?>
    <h2 class="heading-area wow fadeInLeft" data-wow-duration="2s"><?php _e('Lorem Ipsum is simply dummy text of the printing and typesetting industry.','featuredlite');?></h2>
    <?php } else { ?>
    <h2 class="heading-area wow fadeInLeft" data-wow-duration="2s"><?php echo get_theme_mod( 'hb_heading'); ?></h2>
    <?php } ?>
    ...
    <?php  elseif($section=='service'): ?>
      ...
      <h2 class="head-text wow fadeInLeft" data-wow-duration="1s"><?php echo get_theme_mod( 'our_services_heading'); ?></h2>
      <?php } else { ?>
      <h2 class="head-text wow fadeInLeft" data-wow-duration="1s"><?php _e('Our Services','featuredlite');?></h2>
      <?php } ?>
      <?php if(get_theme_mod( 'our_services_subheading')!=''){?>
      <h3 class="subhead-text wow fadeInLeft" data-wow-duration="1s"><?php echo get_theme_mod( 'our_services_subheading'); ?></h3>
      <?php } else { ?>
      <h3 class="subhead-text wow fadeInLeft" data-wow-duration="1s"><?php _e('Lorem Ipsum is simply dummy text of the printing and typesetting industry','featuredlite');?></h3>
      <?php } ?>
      <ul class="multiple-featured-section wow fadeInRight" data-wow-duration="1s">
        <?php
    ...
    <h2 class="head-text wow fadeInLeft" data-wow-duration="1s"><?php echo get_theme_mod( 'our_team_heading'); ?></h2>
    <?php } else { ?>
    <h2 class="head-text wow fadeInLeft" data-wow-duration="1s">
    <?php _e('Our Perfect Team','featuredlite'); ?></h2>
    <?php } ?>
    <?php if(get_theme_mod( 'our_team_subheading')!=''){?>
    <h3 class="subhead-text wow fadeInLeft" data-wow-duration="1s"><?php echo get_theme_mod( 'our_team_subheading'); ?></h3>
    <?php } else { ?>
    <h3 class="subhead-text wow fadeInLeft" data-wow-duration="1s"><?php _e('Lorem Ipsum is simply dummy text of the printing and typesetting industry','featuredlite'); ?></h3>
    <?php } ?>
...
<?php  if(get_theme_mod( 'testimonial_heading')!=''){?>
    <h2 class="head-text wow fadeInRight" data-wow-duration="1s"><?php echo get_theme_mod( 'testimonial_heading'); ?></h2>
    <?php } else { ?>
    <h2 class="head-text wow fadeInRight" data-wow-duration="1s"><?php _e('Happy Customers','featuredlite'); ?></h2>
    <?php } ?>
    <?php if(get_theme_mod( 'testimonial_subheading')!=''){?>
    <h3 class="subhead-text wow fadeInRight" data-wow-duration="1s"><?php echo get_theme_mod( 'testimonial_subheading'); ?></h3>
    <?php } else { ?>
    ...
    <ul class="multiple-testimonial-section wow fadeInLeft" data-wow-duration="1s">
...
<?php if(get_theme_mod( 'our_cnt_heading')!=''){?>
        <h2 class="head-text wow fadeInLeft" data-wow-duration="1s"><?php echo get_theme_mod( 'our_cnt_heading'); ?></h2>
      <?php } else { ?>
        <h2 class="head-text wow fadeInLeft" data-wow-duration="1s">
        <?php _e('Contact us','featured'); ?></h2>
    <?php } ?>
    <?php if(get_theme_mod( 'our_cnt_subheading')!=''){?>
    <h3 class="subhead-text wow fadeInLeft" data-wow-duration="1s"><?php echo get_theme_mod( 'our_cnt_subheading'); ?></h3>
      <?php } else { ?> 
    <h3 class="subhead-text wow fadeInLeft" data-wow-duration="1s"><?php _e('Lorem Ipsum is simply dummy text of the printing and typesetting industry','featured'); ?></h3>
   <?php } ?> 
   <div class="cnt-block">
